 ...
 */
async function buscarVariaveis(idLinha: number): Promise<Variavel> {
 ...
 */
async function updateValorLinha(
  id: number,
  valorTesteLinha: number
): Promise<void> {
  return new Promise((resolve, reject) => {
 ...
 */
async function atualizarValorPrograma(
  nome: string,
  valorTeste: number,
  tipo: Tipo
): Promise<void> {
 ...
 */
async function salvarOuAtualizarPrograma(
  programaNome: string
): Promise<number> {
  return new Promise((resolve, reject) => {
